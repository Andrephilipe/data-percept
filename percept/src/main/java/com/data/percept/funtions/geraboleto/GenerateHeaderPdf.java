...
@RestController
public class GenerateHeaderPdf {
    public static Logger logger = LoggerFactory.getLogger(GenerateHeaderPdf.class);


    public static ResponseEntity<byte[]> generatePdf(OrderPaymentsBoleto remessaBoleto) throws IOException, DocumentException {
